        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              sharing website. By accessing or using our website, you agree to
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              As a user of our website, you are responsible for maintaining the
              confidentiality of your account and password, and for restricting
              access to your computer. You agree to be responsible for all
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              We take the privacy of your data seriously. We will collect and
              use your personal information in accordance with our Privacy
              Policy, which is available on our website. By using our website,
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              The website and its content, features, and functionality are owned
              by our company and are protected by international copyright,
              trademark, patent, trade secret, and other intellectual property
              or proprietary rights laws. You may not modify, copy, distribute,
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              intangible losses (even if our company has been advised of the
              possibility of such damages), resulting from your use of or
              inability to use the website or the performance or non-performance
              of the website.
            </p>
          </div>
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              these terms and conditions, or the breach, termination, or
              validity thereof, shall be resolved by binding arbitration in
              accordance with the rules of the American Arbitration Association.
              The arbitration shall be conducted in the city where our
              company&apos;s principal office is located, and the
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              revised terms and conditions on the website. Your continued use of
