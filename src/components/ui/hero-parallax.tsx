  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-200">
        Efficient inventory management, seamless supply chain, and intelligent
        demand forecasting for modern healthcare facilities. developers and
        designers that love to build amazing products.
      </p>
      <RevealAnimation className="mt-4 flex gap-4">
        <Link
